...
![Alpine Linux ダウンロードページ](../images/IMG_0413.jpeg)
...
![「新規仮想マシンを作成」ボタン](../images/IMG_0414.jpeg)
...
![「新規マシン」オプション](../images/IMG_0415.jpeg)
...
![OSとして「Linux」を選択](../images/IMG_0416.jpeg)
...
![ハードウェアExpert Mode設定](../images/IMG_0417.jpeg)
...
![ディスプレイ出力設定](../images/IMG_0418.jpeg)
...
![起動イメージの種類を選択](../images/IMG_0419.jpeg)
...
![起動ISOイメージの指定完了](../images/IMG_0420.jpeg)
...
![ストレージサイズの設定](../images/IMG_0421.jpeg)
...
![共有ディレクトリの設定](../images/IMG_0422.jpeg)
...
![Alpine Linux起動とログインプロンプト](../images/IMG_0464.jpeg)
...
![rootでのログイン成功](../images/IMG_0466.jpeg)
...
![キーボードレイアウト設定](../images/IMG_0467.jpeg)
...
![ホスト名・ネットワーク・rootパスワード設定](../images/IMG_0469.jpeg)
...
**コメント:** プロキシは無し、NTPクライアントは`busybox`、パッケージミラーは`1`（公式CDN）を選択しています。

![プロキシ・NTP・ミラー設定](../images/IMG_0471.jpeg)
...
![一般ユーザーの作成](../images/IMG_0473.jpeg)
...
**コメント:** OSをディスク(`vda`)に`sys`モードでインストールする処理が完了した場面です。「Installation is complete. Please reboot.」と表示されています。

![ディスクインストールの完了](../images/IMG_0476.jpeg)
...
![ISOイメージ取り出し（作業前）](../images/IMG_0481.jpeg)
...
![ISOイメージ取り出し（作業後）](../images/IMG_0482.jpeg)
...
![ディスクからの初回起動](../images/IMG_0483.jpeg)
...
![ディスク起動後のログインプロンプト](../images/IMG_0484.jpeg)
...
![一般ユーザーでのログイン成功](../images/IMG_0485.jpeg)
